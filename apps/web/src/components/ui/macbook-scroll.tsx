...
export const MacbookScroll = ({
  ...
  return (
    <div
      ref={ref}
      className="my-0  flex min-h-[125vh] shrink-0 scale-[0.605] flex-col items-center justify-start py-0 [perspective:800px] sm:scale-75 md:min-h-[200vh] md:scale-125  md:py-32"
    >
      <motion.h2
        style={{
