  ...
  return (
    ...
    >
      ...
      <div className="container relative mt-16">
        <h1 className="text-6xl md:text-[168px] md:leading-none font-semibold tracking-tighter bg-white bg-[radial-gradient(100%_100%_at_top_left,white,white,rgba(74,32,138,0.5))] text-transparent bg-clip-text text-center">
          Singularity
        </h1>
        <p className="text-lg md:text-xl max-w-2xl mx-auto text-white/70 mt-5 text-center tracking-tight">
          A streamlined result extraction and analysis tool for AKTU-affiliated institutes. Automate your result processing with unparalleled speed and accuracy.
        </p>
